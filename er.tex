\section{Contenidos de la primera entrega}
...
\begin{itemize}
    \item \ent{area}(\pk{\att{nro\_area}}, \att{nombre},
          ...
          \begin{itemize}
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{nro\_area}}{\att{nombre},
                                  \att{es\_restringida}}
    ...
    \item \ent{area\_restringida}(\pk{\fk{\att{nro\_area}}}, \fk{\att{id\_seg}})
          \begin{itemize}
              ...
              \item Para \ent{empleado}.\att{legajo} == \ent{area}.\att{legajo} y
                    \ent{area}.\att{nro\_area} en \- \ent{area\_restringida}.\att{nro\_area},
                    \ent{empleado}.\att{id\_seg} $\geq$ \ent{area\_restringida}.\att{id\_seg}.
              \item \CK{\att{nro\_area}}.
              \item \PK{\att{nro\_area}}.
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{nro\_area}\} es superclave de \ent{area\_restringida} y está del
                              lado izquierdo de su dependencia funcional.
                    \end{itemize}
          \end{itemize}

    \item \ent{auditoria}(\fk{\att{legajo}}, \fk{\att{id\_tarea}},
          \pk{\att{nro\_audit}}, \att{desc}, \att{fecha}, \att{aprobada})
          \begin{itemize}
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{legajo}, \att{id\_tarea},
                                  ...
                                  \att{aprobada}}.
                        \item BCNF(\{\att{legajo}, \att{id\_tarea}, \att{nro\_audit}\} es superclave de
    ...
    \item \ent{contratado}(\pk{\fk{\att{legajo}}})
          \begin{itemize}
              ...
              \item Para \ent{contratado}.\att{legajo} == \ent{profesional}.\att{legajo},
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{legajo}, \att{id\_tarea}}{\att{f\_ing},
                                  \att{f\_fin}}.
                        \item BCNF(\{\att{legajo}, \att{id\_tarea}\} es superclave de \ent{desarrolla} y está
                              del lado izquierdo de su dependencia funcional).
                    \end{itemize}
          \end{itemize}
    ...
    \item \ent{direccion}(\pk{\att{id\_dir}}, \att{f\_ini}, \att{f\_fin},
          ...
          \begin{itemize}
              ...
              \item \ent{direccion}.\att{nro\_area} debe estar en
                    \ent{area}.\att{nro\_area}.
              \item \ent{direccion}.\att{f\_fin} puede ser nulo si el director
                    sigue en su puesto.
              \item \CK{\att{id\_dir}), (\att{f\_ini}, \att{f\_fin},
                        \att{id\_area}}.
              \item \PK{\att{id\_dir}}.
              \item \FK{\att{nro\_area}}.
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{(\att{id\_dir}),
                                  (\att{f\_ini}, \att{f\_fin}, \att{nro\_area})}
                              {(\att{f\_ini}, \att{f\_fin}, \att{nro\_area}),
                                  (\att{id\_dir})}.
    ...
    \item \ent{Empleado}(\pk{\att{Legajo}}, \att{Nombre}, \att{Apellido},
          ...
          \begin{itemize}
              ...
              \item \ent{Empleado}.\att{Tipo\_empl} es \{0 (\ent{profesional}), 1
                    (\ent{no\_profesional}), 2 (\ent{jerarqui\-co})\}.
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF({\att{legajo}} es superclave de \ent{empleado}, está del lado izquierdo de
                              su dependencia funcional).
                    \end{itemize}
          \end{itemize}

    \item \ent{entrada\_salida}(\pk{\fk{\att{legajo}}},
          \pk{\fk{\att{nro\_area}}}, \att{fecha}, \att{es\_entrada},
          \att{autorizado})
          \begin{itemize}
              ...
              \item Si \ent{entrada\_salida}.\att{legajo} está en
                    \ent{planta\_permanente}.\att{legajo} entonces \att{legajo} debe determinar
                    funcionalmente a \att{nro\_area}.
              \item \ent{entrada\_salida}.\att{es\_entrada} es \{\texttt{true},
                    \texttt{false}\}.
              \item \ent{entrada\_salida}.\att{autorizado} es \{\texttt{true},
                    \texttt{false}\}.
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{legajo}, \att{nro\_area}}
                              {\att{fecha}, \att{es\_entrada}, \att{autorizado}}.
                        \item Como \{\att{legajo}, \att{nro\_area}\} es superclave y esta a la izquierda es
                              BCNF.
                    \end{itemize}
          \end{itemize}
          ...
          \begin{itemize}
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{id\_esp}\} es superclave de \ent{especialidad} y está del lado
                              izquierdo de su dependencia funcional).
                    \end{itemize}
          \end{itemize}

    \item \ent{evento}(\fk{\att{nro\_area}}, \pk{\att{nro\_evento}},
          \att{desc}, \att{fecha})
          \begin{itemize}
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{nro\_evento}}
                              {\att{nro\_area}, \att{desc}, \att{fecha}}.
                        \item BCNF(\att{nro\_evento} es superclave de \ent{evento} y está del lado izquierdo
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item \fmin{\att{id\_franja}}{\att{hora\_entrada},
                                  \att{hora\_salida}}.
                        \item BCNF(\{\att{hora\_entrada}, \att{hora\_salida}\} e \att{id\_franja} son
                              superclave de \- \ent{franja\_horaria} y ambas están del lado izquierdo de su
    ...
    \item \ent{jerarquico}(\pk{\fk{\att{legajo}}})
          \begin{itemize}
              \item \ent{jerarquico}.\att{legajo} debe estar en
                    \ent{empleado}.\att{legajo}.
              \item Para \ent{jerarquico}.\att{legajo} == \ent{empleado}.\att{legajo},
                    \ent{empleado}.\att{tipo\_empl} = 2.
    ...
    \item \ent{no\_profesional}(\pk{\fk{\att{legajo}}})
          \begin{itemize}
              \item \ent{no\_profesional}.\att{legajo} debe estar en
                    \ent{empleado}.\att{legajo}.
              \item Para \ent{no\_profesional}.\att{legajo} == \ent{empleado}.\att{legajo},
    ...
    \item \ent{planta\_permanente}(\pk{\fk{\att{legajo}}},
          ...
          \begin{itemize}
              ...
              \item \ent{planta\_permanente}.\att{nro\_area} debe estar en
                    \ent{area}.\att{nro\_area}.
              \item Para \ent{planta\_permanente}.\att{legajo} == \ent{profesional}.\att{legajo},
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{legajo}}{\att{nro\_area}}.
                        \item BCNF(\{\att{legajo}\} es superclave de \ent{planta\_permanente} y está del lado
                              izquierdo de su dependencia funcional).
                    \end{itemize}
          \end{itemize}
    ...
    \item \ent{profesional}(\pk{\fk{\att{legajo}}}, \att{tipo\_prof},
          ...
          \begin{itemize}
              ...
              \item Para \ent{profesional}.\att{legajo} == \ent{empleado}.\att{legajo},
              ...
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{\att{legajo}}{\att{tipo\_prof},
                                  \att{id\_esp}}.
                        \item BCNF(\{\att{legajo}\} es superclave de \ent{profesional} y está del lado
                              izquierdo de su dependencia funcional.
                    \end{itemize}
          \end{itemize}
    ...
    \item \ent{seguridad}(\pk{\att{Id\_seg}}, \att{Desc}, \att{Nivel})
          \begin{itemize}
              ...
              \item Los niveles de seguridad se ordenan según \att{nivel}. Con esto se permite
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{id\_seg}\} es superclave de \ent{seguridad} y está del lado
                              izquierdo de su dependencia funcional.
                    \end{itemize}
          \end{itemize}
          ...
          \begin{itemize}
              ...
              \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{id\_tarea}\} es superclave de \ent{tarea} y está del lado izquierdo
                              de su dependencia funcional.
                    \end{itemize}
          \end{itemize}
    ...
    \item \ent{trabaja\_en}(\pk{\fk{\att{legajo}}}, \pk{\fk{\att{nro\_area}}},
          ...
          \begin{itemize}
              ...
              \item \ent{Empleado}.\att{id\_seg} de
                    ...
                    \ent{trabaja\_en}.\att{nro\_area}
              \item Si \ent{Trabaja\_en}.\att{legajo} $=$ \ent{Trabaja\_en}.\att{legajo} con
                    \ent{Trabaja\_en} $\neq$ \ent{Trabaja\_en}, $\Longrightarrow$
                    \ent{Trabaja\_en}.\att{franja\_horaria} $\neq$
                    \ent{Trabaja\_en}.\att{franja\_horaria}.
              \item \CK{\att{legajo}, \att{nro\_area}}.
              \item \PK{\att{legajo}, \att{nro\_area}}.
              \item \FK{\att{legajo}), (\att{nro\_area}), (\att{id\_franja}}.
              \item Normalización:
                    \begin{itemize}
                        \item \fmin{(\att{legajo}, \att{id\_tarea}),
                                  (\att{legajo}, \att{id\_franja})}
                              {(\att{id\_franja}), (\att{nro\_area})}
                        \item BCNF(\{\att{legajo}, \att{nro\_area}\} y \{\att{legajo}, \att{id\_franja}\} son
                              superclave de \ent{trabaja\_en} y ambas están del lado izquierdo de su
                              dependencia funcional)
                    \end{itemize}
          \end{itemize}
