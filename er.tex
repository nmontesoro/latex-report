...
\begin{itemize}
    ...
    \item En ningún atributo es posible asignar una fecha posterior a la fecha
        de carga de datos.
    \item No es posible que se produzca superposición entre dos períodos 
        temporales del mismo tipo (fechas de inicio y finalización).
\end{itemize}
    ...
    \item \ent{profesional}(\pk{\fk{\att{legajo}}}, \att{tipo\_prof}, 
            ...
            \begin{itemize}
                ...
                \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{id\_esp}\} es superclave de 
            ...
            \begin{itemize}
                ...
                \item Normalización:
                    \begin{itemize}
                        ...
                        \item BCNF(\{\att{legajo}\} es superclave de 
                            \ent{planta\_permanente} y está del lado izquierdo 
        ...
        \item \ent{trabaja\_en}(\pk{\fk{\att{legajo}}}, \pk{\fk{\att{nro\_area}}},
            ...
            \begin{itemize}
                ...
                \item Si \ent{Trabaja\_en}.\att{legajo} $=$
                    \ent{Trabaja\_en}.\att{legajo} con \ent{Trabaja\_en} $\neq$
                    \ent{Trabaja\_en}, $\Longrightarrow$ 
            ...
            \begin{itemize}
                ...
                \item Normalización:
                    \begin{itemize}
                        ...
                        \item Como \{\att{legajo}, \att{nro\_area}\} es 
                            superclave y esta a la izquierda es BCNF.
                    \end{itemize}
            \end{itemize}
